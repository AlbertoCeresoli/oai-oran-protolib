...
_RAN_PARAMETER = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RRM_POLICY_RATIO', index=2, number=4,
      serialized_options=None,
      type=None),
  ],
  containing_type=None,
...
_RAN_PARAM_MAP_ENTRY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='rrmPolicyRatio', full_name='RAN_param_map_entry.rrmPolicyRatio', index=4,
...
_SLICE_POLICY_M = _descriptor.Descriptor(
  name='slice_policy_m',
  full_name='slice_policy_m',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='s_id', full_name='slice_policy_m.s_id', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='min_ratio', full_name='slice_policy_m.min_ratio', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='max_ratio', full_name='slice_policy_m.max_ratio', index=2,
...
_RRMPOLICYRATIO_M = _descriptor.Descriptor(
  name='rrmPolicyRatio_m',
  full_name='rrmPolicyRatio_m',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='slice_policies', full_name='rrmPolicyRatio_m.slice_policies', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_RAN_PARAM_MAP_ENTRY.fields_by_name['rrmPolicyRatio'].message_type = _RRMPOLICYRATIO_M
...
_RAN_PARAM_MAP_ENTRY.oneofs_by_name['value'].fields.append(
  _RAN_PARAM_MAP_ENTRY.fields_by_name['rrmPolicyRatio'])
_RAN_PARAM_MAP_ENTRY.fields_by_name['rrmPolicyRatio'].containing_oneof = _RAN_PARAM_MAP_ENTRY.oneofs_by_name['value']
...
_RRMPOLICYRATIO_M.fields_by_name['slice_policies'].message_type = _SLICE_POLICY_M
...
DESCRIPTOR.message_types_by_name['slice_policy_m'] = _SLICE_POLICY_M
DESCRIPTOR.message_types_by_name['rrmPolicyRatio_m'] = _RRMPOLICYRATIO_M
...
slice_policy_m = _reflection.GeneratedProtocolMessageType('slice_policy_m', (_message.Message,), dict(
  DESCRIPTOR = _SLICE_POLICY_M,
  __module__ = 'ran_messages_pb2'
  # @@protoc_insertion_point(class_scope:slice_policy_m)
  ))
_sym_db.RegisterMessage(slice_policy_m)

rrmPolicyRatio_m = _reflection.GeneratedProtocolMessageType('rrmPolicyRatio_m', (_message.Message,), dict(
  DESCRIPTOR = _RRMPOLICYRATIO_M,
  __module__ = 'ran_messages_pb2'
  # @@protoc_insertion_point(class_scope:rrmPolicyRatio_m)
  ))
_sym_db.RegisterMessage(rrmPolicyRatio_m)
