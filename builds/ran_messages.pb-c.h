...
typedef struct _SlicePolicyM SlicePolicyM;
typedef struct _RrmPolicyRatioM RrmPolicyRatioM;
...
typedef enum _RANParameter {
  ...
  RAN_PARAMETER__RRM_POLICY_RATIO = 4
...
typedef enum {
  ...
  RAN_PARAM_MAP_ENTRY__VALUE_RRM_POLICY_RATIO = 5
...
struct  _RANParamMapEntry
{
  ...
  union {
    ...
    char *string_value;
    UeListM *ue_list;
    RrmPolicyRatioM *rrmpolicyratio;
  };
};
 ...
 * Slice policy 
 */
struct  _SlicePolicyM
{
  ProtobufCMessage base;
  protobuf_c_boolean has_s_id;
  int32_t s_id;
  protobuf_c_boolean has_min_ratio;
  int32_t min_ratio;
  protobuf_c_boolean has_max_ratio;
  int32_t max_ratio;
};
#define SLICE_POLICY_M__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&slice_policy_m__descriptor) \
    , 0, 0, 0, 0, 0, 0 }


struct  _RrmPolicyRatioM
{
  ProtobufCMessage base;
  size_t n_slice_policies;
  SlicePolicyM **slice_policies;
};
#define RRM_POLICY_RATIO_M__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&rrm_policy_ratio_m__descriptor) \
    , 0,NULL }
...
typedef void (*RANMessage_Closure)
                 (const RANMessage *message,
                  void *closure_data);
typedef void (*SlicePolicyM_Closure)
                 (const SlicePolicyM *message,
                  void *closure_data);
typedef void (*RrmPolicyRatioM_Closure)
                 (const RrmPolicyRatioM *message,
                  void *closure_data);
...
extern const ProtobufCMessageDescriptor slice_policy_m__descriptor;
extern const ProtobufCMessageDescriptor rrm_policy_ratio_m__descriptor;
